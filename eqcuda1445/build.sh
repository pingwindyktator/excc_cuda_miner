...
g++ $CXX_FLAGS -fPIC -Wl,-soname,libeqcuda1445.so -shared -o libeqcuda1445.so eqcuda1445.o solver.o blake.o -L/opt/cuda/lib64 -L/usr/local/cuda/lib64 -lcudart_static  -ldl -lrt -lpthread
